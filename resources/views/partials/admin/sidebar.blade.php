...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="index.html" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>Royal Cars</h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{route('message.index')}}" class="nav-item nav-link"><i class="me-2 bi bi-chat-dots-fill"></i>Message </a>
